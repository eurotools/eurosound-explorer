    ...
    public class SbiBankReader : SfxFunctions
    {
        ...
        public SoundbankInfoHeader ReadSoundbankInfoHeader(string filePath, string platform)
        {
            ...
            using (BinaryReader BReader = new BinaryReader(File.Open(filePath, FileMode.Open, FileAccess.Read, FileShare.Read)))
            {
                ...
                headerData.FileStart1 = BytesFunctions.FlipData(BReader.ReadUInt32(), headerData.IsBigEndian);
                //Size of the first section, in bytes. 
                headerData.FileLength1 = BytesFunctions.FlipData(BReader.ReadUInt32(), headerData.IsBigEndian);

                //Offset to the second section with the sample data. 
                headerData.FileStart2 = BytesFunctions.FlipData(BReader.ReadUInt32(), headerData.IsBigEndian);
                //Size of the second section, in bytes. 
                headerData.FileLength2 = BytesFunctions.FlipData(BReader.ReadUInt32(), headerData.IsBigEndian);
            }
        ...
        public SbiFile ReadSoundbankInfoFile(string filePath, SoundbankInfoHeader headerData)
        {
            ...
            using (BinaryReader binaryReader = new BinaryReader(File.Open(filePath, FileMode.Open, FileAccess.Read, FileShare.Read)))
            {
                ...
                {
                    sbiFileObj.projectSoundBanks[i] = BytesFunctions.FlipData(binaryReader.ReadInt32(), headerData.IsBigEndian);
                }
                ...
                {
                    sbiFileObj.projectMusicBanks[i] = BytesFunctions.FlipData(binaryReader.ReadInt32(), headerData.IsBigEndian);
                }
            }
