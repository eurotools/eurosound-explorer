...
namespace MusX.Writers
{
    ...
    {
        //-------------------------------------------------------------------------------------------------------------------------------
        public static void BuildSoundbankFile(string sfxFilePath, string sifFilePath, string sbFilePath, string ssFilePath, string OutputFilePath, string platform, uint fileHashCode, bool bigEndian, int fileVersion)
        {
